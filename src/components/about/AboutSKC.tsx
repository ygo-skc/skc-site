			...
			<Topic
				...
				details={
					<Typography variant='body1' className='topic-details'>
						...
						going and built a full blown Database for Yu-Gi-Oh content. There is some stuff missing and my site is far from perfect, but It will be one of the best sites for
